...
// Renders the course cards on screen for a given course list
...
// Adds up credits for the currently displayed courses using reduce
...
// Filters by All / WDD / CSE using filter
...
filterButtons.forEach((button) => {
  button.addEventListener("click", () => {
    ...
    const filtered = filterCourses(button.dataset.filter);
